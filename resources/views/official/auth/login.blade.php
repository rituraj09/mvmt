        ...
        <div class="col-lg-4 mx-auto">  
            <div class="row  w-100">
                <div class="col-md-2 mx-auto"> 
                    <img class="align-items-center" src="{{ asset('images/logo_main_black.png') }}" alt="logo" style="width: 100px;">
                </div>
            </div>
            <div class="row">       
                <div class="col-md-12 mx-auto"> 
                    <h4 class="text-center">Files & Daks Tracking System</h4> 
                </div>
            </div>
            ...
            <div class="auto-form-wrapper"> 
                <div class="card">
                    <div class="p-4 border-bottom bg-light"> 
                        <h4 class="card-title mb-0">Officials Login</h4>
                    </div>
                    <div class="card-body">
            ...
            <p class="text-center  mt-5">All right reserved by Directorate of Information Technology, ELectronics & Communication, Government of Assam</p>
            <p class="text-center   mt-5">Developed by DITEC, Assam</p>
        </div>
    </div>
</div>
